...
| `cognitive_accessibility` | 4.0 | 公式：0.55×*D*reg + 0.45×*D*trans；"武器"为高频常规隐喻，*D*reg≈0.8，*D*trans≈0.7，计算值≈0.76，对应4级（0.60-0.79） |
...
计算：*D*abstract = 0.25×0.80 + 0.50×0.33 + 0.25×0.40 = 0.465，*D*processing = 0.6×0.33 + 0.4×0 = 0.198，原始分 = 0.55×0.465 + 0.45×0.198 ≈ 0.345。经五分位数转换后对应2级（较简单），与MD=2类型均值一致。
